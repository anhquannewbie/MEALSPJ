...
from meals.views import student_payment_edit,ajax_load_students,ajax_load_previous_balance,ajax_load_payment_details,ajax_load_mealdata,statistics_view,ajax_load_months,export_monthly_statistics
urlpatterns = [
